...
public class AddressIndexTestSearch18Test extends AddressIndexTestBase {
    ...
    public void verifySearch18Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "10013042137";
        String searchInputText = "Flat 1b Angel Pavement 145 - 147 For Street EX4 3AN";
