...
public class AddressIndexTestSearch27Test extends AddressIndexTestBase {
    ...
    public void verifySearch27Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "100041143618";
        String searchInputText = "158A PENNSYLVANIA ROAD EXETER EX4 6DX";
