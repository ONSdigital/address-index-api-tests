...
public class AddressIndexTestSearch08Test extends AddressIndexTestBase {
    ...
    public void verifySearch08Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "10023122007";
        String searchInputText = "Flat 1 156 Pihoe Road EX4";
