...
public class AddressIndexTestSearch14Test extends AddressIndexTestBase {
    ...
    public void verifySearch14Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "10023121725";
        String searchInputText = "Ground Floor Flat 21 Park Road Exeter EX1 2SH";
