...
public class AddressIndexTestSearch03Test extends AddressIndexTestBase {
    ...
    public void verifySearch03Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "100041142491";
        String searchInputText = "flat 21 montpelier court st davids hill exeter devon ex4 4dp";
