...
public class AddressIndexTestSearch29Test extends AddressIndexTestBase {
    ...
    public void verifySearch29Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "10023119818";
        String searchInputText = "76 CHAUCER GROVE EX4 7BX";
