...
public class AddressIndexTestSearch21Test extends AddressIndexTestBase {
    ...
    public void verifySearch21Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "100040234036";
        String searchInputText = "48c South Street EX11EE";
