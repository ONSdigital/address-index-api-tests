...
public class AddressIndexTestSearchTest17 extends AddressIndexTestBase {
    ...
    public void verifySearchTest17(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "10013041009";
        String searchInputText = "BLUE ARROW PORTLAND HOUSE EXETER";
