...
public class AddressIndexTestSearch05Test extends AddressIndexTestBase {
    ...
    public void verifySearch05Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "10013048119";
        String searchInputText = "1 The Court 122  Fore Street EX4";
