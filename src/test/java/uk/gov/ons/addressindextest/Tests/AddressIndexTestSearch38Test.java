...
public class AddressIndexTestSearch38Test extends AddressIndexTestBase {
    ...
    public void verifySearch38Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "10023117621";
        String searchInputText = " WHIPTON BARTON INFANTS AND NURSERY SCHOOL, HILL LANE, EXETER, EX1 3JP";
