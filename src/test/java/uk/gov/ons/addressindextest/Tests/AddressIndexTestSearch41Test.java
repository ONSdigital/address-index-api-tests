...
public class AddressIndexTestSearch41Test extends AddressIndexTestBase {
    ...
    public void verifySearch41Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "100040233625";
        String searchInputText = "THE AL BARAKA EXETER, EX4 6RY";
