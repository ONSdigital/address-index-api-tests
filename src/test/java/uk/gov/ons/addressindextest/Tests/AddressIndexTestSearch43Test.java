...
public class AddressIndexTestSearch43Test extends AddressIndexTestBase {
    ...
    public void verifySearch43Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "10091469256";
        String searchInputText = "PACKEXE, 9 MARSH GREEN ROAD NORTH, EXETER, EX2 8NY";
