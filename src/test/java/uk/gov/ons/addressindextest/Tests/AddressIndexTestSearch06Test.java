...
public class AddressIndexTestSearch06Test extends AddressIndexTestBase {
    ...
    public void verifySearch06Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "100041131820";
        String searchInputText = "Flat 3 Crescent Mansion Mount Radfrd Crescent Exeter EX2 4ER";
