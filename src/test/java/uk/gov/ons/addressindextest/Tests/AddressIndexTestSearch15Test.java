...
public class AddressIndexTestSearch15Test extends AddressIndexTestBase {
    ...
    public void verifySearch15Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "10013045985";
        String searchInputText = "FLAT 1ST FLOOR 4 ST JAMES ROAD EXETER EX4";
