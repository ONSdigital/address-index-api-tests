...
public class AddressIndexTestSearch39Test extends AddressIndexTestBase {
    ...
    public void verifySearch39Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "10013039230";
        String searchInputText = "REGENTS PARK CHILDRENS HOME, 49 REGENTS PARK, EXETER, EX1 2NZ";
