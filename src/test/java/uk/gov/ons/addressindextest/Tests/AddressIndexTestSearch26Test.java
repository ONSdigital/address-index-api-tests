...
public class AddressIndexTestSearch26Test extends AddressIndexTestBase {
    ...
    public void verifySearch26Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "100040211224";
        String searchInputText = "56 EAST GROVE ROAD EXETER EX2";
