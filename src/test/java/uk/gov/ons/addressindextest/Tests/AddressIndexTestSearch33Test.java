...
public class AddressIndexTestSearch33Test extends AddressIndexTestBase {
    ...
    public void verifySearch33Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "100041046010";
        String searchInputText = "115C SIDWELL STREET, EXETER, EX4 6RY";
