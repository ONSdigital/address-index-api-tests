...
public class AddressIndexTestSearch32Test extends AddressIndexTestBase {
    ...
    public void verifySearch32Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "100041131825";
        String searchInputText = "8 CRESCENT MANSIONS, MOUNT RADFORD CRESCENT, EXETER, EX2 4ER";
