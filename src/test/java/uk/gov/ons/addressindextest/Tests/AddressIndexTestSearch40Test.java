...
public class AddressIndexTestSearch40Test extends AddressIndexTestBase {
    ...
    public void verifySearch40Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "100040226838";
        String searchInputText = "THE LILACS RESIDENTIAL HOME, 42-44 OLD TIVERTON ROAD, EXETER, EX4 6NG";
