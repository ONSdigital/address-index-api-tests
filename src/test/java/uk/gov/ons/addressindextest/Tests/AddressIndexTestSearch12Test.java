...
public class AddressIndexTestSearch12Test extends AddressIndexTestBase {
    ...
    public void verifySearch12Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "10091470005";
        String searchInputText = "Lyndhurst Streatham Rise";
