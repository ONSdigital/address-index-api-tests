...
public class AddressIndexTestSearch25Test extends AddressIndexTestBase {
    ...
    public void verifySearch25Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "100040207227";
        String searchInputText = "63A CHESTNUT AVENUE EXETER";
