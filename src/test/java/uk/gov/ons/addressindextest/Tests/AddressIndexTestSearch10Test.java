...
public class AddressIndexTestSearch10Test extends AddressIndexTestBase {
    ...
    public void verifySearch10Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "10013050229";
        String searchInputText = "31, Constantine House, New North Road, Exeter, Devon EX4 4JH";
