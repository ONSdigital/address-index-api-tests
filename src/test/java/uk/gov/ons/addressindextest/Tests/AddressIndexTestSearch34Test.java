...
public class AddressIndexTestSearch34Test extends AddressIndexTestBase {
    ...
    public void verifySearch34Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "10013046821";
        String searchInputText = "FLAT 5, BARTHOLOMEW HOUSE, BARTHOLOMEW STREET WEST, EXETER, EX4 3AJ";
