...
public class AddressIndexTestSearch20Test extends AddressIndexTestBase {
    ...
    public void verifySearch20Test(String browser, String version, String os, Method method)
    throws MalformedURLException, InvalidElementStateException, UnexpectedException {

        String uprn = "100040233649";
        String searchInputText = "152c sidwell street ex46rt";
